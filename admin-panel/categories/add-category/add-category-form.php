                            ...
                            <form action="categories/category-list/display-categories.php" method="post" novalidate="novalidate">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <div class="col-20 col-md-20">
                                        <select name="subcategory-select" id="select-sub-category" class="form-control">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <div class="col-20 col-md-20">
                                        <select name="category-parent-select" id="select-parent-category" class="form-control" placeholder="Disabled" disabled='false'>
                                            <option value="2">Please select</option>
                                            <option value="1">Yes</option>
                                            <option value="0">No</option>
                                        </select>
