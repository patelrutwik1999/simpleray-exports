...
$get_connected_category = "select category_id, category_name from categories where parent_category_id = '$category_id_to_delete'";
...
while ($categories = mysqli_fetch_array($connected_categories)) {
    ...
    $delete_corresponding_categories = "delete from categories where category_id = '$correspond_category'";
