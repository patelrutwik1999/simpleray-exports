                                            ...
                                            <div class="gi-product-content">
                                                <div class="gi-product-inner">
                                                    ...
                                                    <div class="gi-pro-content">
                                                        ...
                                                        <h5 class="gi-pro-title"><a href="products/product-page/product-page.php?category_id=<?php echo $allProducts['parent_category_id']; ?>"><?php echo $allProducts['product_name']; ?></a></h5>
                                                ...
                                                <div class="gi-product-content">
                                                    <div class="gi-product-inner">
                                                        ...
                                                        <div class="gi-pro-content">
                                                            ...
                                                            <h5 class="gi-pro-title"><a href="products/product-page/product-page.php?category_id=<?php echo $products['parent_category_id']; ?>">
                                                ...
                                                <div class="gi-product-content">
                                                    <div class="gi-product-inner">
                                                        ...
                                                        <div class="gi-pro-content">
                                                            ...
                                                            <h5 class="gi-pro-title"><a href="products/product-page/product-page.php?category_id=<?php echo $allProducts['parent_category_id']; ?>">
