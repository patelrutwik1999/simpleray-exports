                        ...
                        <div class="row">
                                ...
                                <div class="single-product-scroll">
                                    <div class="single-product-cover">
                                        <div class="single-slide zoom-image-hover">
                                            <img class="img-responsive" src="assets/img/product-images/4_1.jpg" alt="">
                                        </div>
                                        <div class="single-slide zoom-image-hover">
                            ...
                            <div class="single-pro-desc single-pro-desc-no-sidebar m-t-991">
                                <div class="single-pro-content">
                                    <h5 class="gi-single-title">Potato Chips 52g, American Cream & Onion Flavour,
                                        Crunchy Chips & Snacks.</h5>
                                    ...
                                    <div class="gi-single-price-stoke">
                                        <div class="gi-single-price">
                                            <div class="final-price">$664.00<span class="price-des">-78%</span>
                                            </div>
                                    ...
                                    <div class="gi-single-desc">Lorem Ipsum is simply dummy text of the printing and
