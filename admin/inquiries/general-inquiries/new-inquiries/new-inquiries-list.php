                    ...
                    <div class="email-rightbar mb-3" style="margin: auto;">
                        ...
                        <div class="card">
                            ...
                            <ul class="message-list">
                                ...
                                $get_general_inquiries = "select * from general_inquiries where read_status = 0 order by submitted_on desc";
                        ...
                        $records_per_page = 5;
                        $sum = 0;
                        $count_query = "SELECT COUNT(*) FROM general_inquiries where read_status = 0";
