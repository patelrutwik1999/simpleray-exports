...
<head>
    <!-- Title Page-->
    <title>Product Inquiries List - Processed</title>
    ...
    ?>
    <link href="inquiries/product-inquiries/processed-inquiries/processed-inquiries-list.css" rel="stylesheet"
        media="all">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#delete_inquiry', function () {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: 'inquiries/product-inquiries/delete-inquiry/delete-inquiry.php',
                            type: 'POST',
                            data: 'inquiry_id=' + id,
                            dataType: 'json'
                        })
