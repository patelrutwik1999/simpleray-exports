                    ...
                    <div class="email-rightbar mb-3" style="margin: auto;">
                        ...
                        <div class="card">
                            <div class="btn-toolbar p-3" role="toolbar">
                                <div class="col-md-8">
                                    <div class="btn-group me-2 mb-2 mb-sm-0">
                                        <a href="inquiries/product-inquiries/all-inquiries/display-all-inquiries.php">
                                            <button type="button"
                                                class="btn btn-primary waves-light waves-effect">All</button>
                                        </a>
                                    </div>
                                    <div class="btn-group me-2 mb-2 mb-sm-0">
                                        <a href="inquiries/product-inquiries/new-inquiries/display-new-inquiries.php">
                                            <button type="button"
                                    ...
                                    <div class="btn-group me-2 mb-2 mb-sm-0">
                                        <a
                                            href="inquiries/product-inquiries/processed-inquiries/display-processed-inquiries.php">
                                            <button type="button"
                            ...
                            <ul class="message-list">
                                ...
                                $get_product_inquiries = "select * from product_inquiries where read_status = 1 order by submitted_on desc";
                                        ...
                                        <div class="col-mail col-mail-1">
                                            <div>
                                                <button type="button"
                                                    ...
                                                    id="delete_inquiry"
                                                    data-id="<?php echo $retrieved_product_inquiries['inquiry_id'] ?>"><i
                                                        style="line-height: 1.5rem; margin: auto auto; font-size:large;"
                                                        class="far fa-trash-alt"></i></button>
                                            </div>Í
                                            <a href="inquiries/product-inquiries/processed-inquiries/view-specific-inquiry/view.php?id=<?php echo $retrieved_product_inquiries['inquiry_id'] ?>"
                                                class="title">
                        ...
                        $records_per_page = 5;
                        $sum = 0;
                        $count_query = "SELECT COUNT(*) FROM product_inquiries where read_status = 1";
